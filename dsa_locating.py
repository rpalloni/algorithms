...
locate_number_linear(test['input']['array'], test['input']['number']) == test['output']
# or locate_number_linear(**test['input']) == test['output']
...
locate_number_binary(test['input']['array'], test['input']['number']) == test['output']
# or locate_number_binary(**test['input']) == test['output']
